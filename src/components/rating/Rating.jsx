...
export default function Rating(ratingData){
    const rating = Math.floor(ratingData.rating.rate);
    let estimation = [];
    ...
    return(
        <div className="ratingBlock" style={{display: "flex", gap: "10px"}}>
            {
                estimation.map(item => {
                    if(item){
                        return(
                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                width="20px" height="20px" viewBox="0 0 1280.000000 1216.000000"
